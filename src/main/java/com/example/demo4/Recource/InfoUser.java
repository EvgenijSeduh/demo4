...
public class InfoUser extends Requirements {
    ...
    public boolean isFill(){
        if((login != null && password!=null && name !=null &&country != null && city !=null && street !=null && home !=null && numberPass != null && seriesPass!=null) &&(!login.isEmpty() && password.length!=0 && !name.isEmpty() && !country.isEmpty() && !city.isEmpty() && !street.isEmpty() && !home.isEmpty() && !numberPass.isEmpty() && !seriesPass.isEmpty()))
            return true;
        else
            return false;
    }
    ...
    public boolean setMandat(int numberMandat) {
        switch (numberMandat){
            case 1:
                this.mandat = "clients";
                return true;
            case 2:
                this.mandat = "employee";
                return true;
            case 3:
                this.mandat = "super_user";
                return true;
            default:
                return false;
        }
